...
### Self Check
- Did you properly chain class selectors for each rule? Check
- Does the `proportioned` image retain its original square proportions? Check
- Does the `distorted` image end up looking squished and, well, distorted? Check